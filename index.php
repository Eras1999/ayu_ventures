...
<main class="main">
        ...
        <div class="col-lg-6">
          <div class="hero-content">
            ...
            <h1 data-aos="fade-right" data-aos-delay="300">
              Building the Future
              of <span class="highlight">Pharmaceutical</span> Manufacturing
            </h1>
            ...
            <div class="hero-actions" data-aos="fade-right" data-aos-delay="600">
              <a href="what_we_do.php" class="btn btn-primary">Learn More</a>
 ...
 <!-- Home About Section (AYU Style) -->
<section id="home-about" class="home-about-ayu section">
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="row align-items-center g-4">

      <!-- LEFT: Images -->
      <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
        <div class="ayu-about-images">
          <!-- Main big image -->
          <div class="ayu-main-img">
            <img src="assets/img/home/who_we_are/11.png" alt="Lab / Medical" class="img-fluid">
          </div>

          <!-- Small overlay image -->
          <div class="ayu-mini-img">
            <img src="assets/img/home/who_we_are/1.png" alt="Medicine" class="img-fluid">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
        <div class="ayu-about-content">
          <h1 class="ayu-title">Who We Are</h1>
          <h3 class="ayu-subtitle">About AYU Ventures</h3>
          ...
          <a href="what_we_do.php" class="ayu-btn">Read More</a>
        </div>
      </div>
...
<!-- Visiion Mission Section -->
<section class="vm-section">
  <div class="container-fluid px-0">

    <!-- Vision Row -->
    <div class="vm-row">
      <div class="vm-block vm-green">
      ...
      <div class="vm-block vm-image" style="background-image:url('assets/img/home/vi_mi/1.png');"></div>
    </div>

    <br>

    <!-- Mission Row (Reverse) -->
    <div class="vm-row vm-reverse">
      <div class="vm-block vm-image" style="background-image:url('assets/img/home/vi_mi/3.png');"></div>

      <div class="vm-block vm-green">
        <div class="vm-content">
          <h2>Our Mission</h2>
          <p>
            To deliver high-quality pharmaceutical resources and healthcare support through strong global partnerships,
            ethical practices, and continuous improvement—ensuring safety, efficiency, and measurable value for
            manufacturers, institutions, and people.
          </p>
        </div>
      </div>
    </div>
